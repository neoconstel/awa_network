...
ArticleCategory, Article, Seller, ProductCategory, ProductLicense,
ProductRating, Product, ProductXProductlicense, ProductXImage)
...
admin.site.register(ProductXProductlicense)
