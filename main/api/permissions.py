...
class IsReviewerElseReadOnly(permissions.BasePermission):
    '''The request allows full access if user is Reviewer and review owner, 
    else it only allows read-only access'''
